...
class RecordSpotWidget extends StatefulWidget {
  const RecordSpotWidget({Key? key}) : super(key: key);

  @override
  _RecordSpotWidgetState createState() => _RecordSpotWidgetState();
}

class _RecordSpotWidgetState extends State<RecordSpotWidget> {
