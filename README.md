...
### 今後の展望
 展望1　提供されたデータが大阪のみだったため, 大阪上空のマップしか作成できなかったが, 提供依頼をして全国版マップを作成したい
 展望2　衛星画像から街の明かりだけでなく町の夜景(明るさ+建物や地形の高低差)、魚の密集地(海の色の変化)、渋滞状況(道路に含まれるほかの色の割合)も表示し、より旅を充実できるアプリにしたい
 展望3　曇り予報をアプリの地図上に表示し、任意の時間で星を見えるか確認できるようにしたい
 展望4　投稿された夜景数が多ければより便利なアプリになるので、思わず夜景をUpしたくなるような機能を導入したい
 展望5　投稿数に応じて読み込み上限やブックマーク上限を開放したりできるPro会員機能を導入したい
 展望6　自分たちが開発した衛星で撮影した写真を使って最新の情報を提供したい
 展望7　国際宇宙ステーションなどの特定の衛星が見える場所や他天体の見える方向などを表示したい
 展望8 同じ条件で撮影した複数の夜景と衛星、地形情報を学習させ、周辺地域の明るさも計算に含めた機械学習モデルを導入しより精度を向上したい
