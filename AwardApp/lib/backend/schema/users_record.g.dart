    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'numberActiveBookings':
          ...
          break;
        case 'numberStamps':
          result.numberStamps = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int?;
          break;
...
class _$UsersRecord extends UsersRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is UsersRecord &&
        ...
        numberStamps == other.numberStamps &&
        ffRef == other.ffRef;
  }
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  int? _numberStamps;
  int? get numberStamps => _$this._numberStamps;
  set numberStamps(int? numberStamps) => _$this._numberStamps = numberStamps;
