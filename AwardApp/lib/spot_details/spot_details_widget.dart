...
class SpotDetailsWidget extends StatefulWidget {
  const SpotDetailsWidget({
    Key? key,
    this.propertyRef,
  }) : super(key: key);
  ...
  @override
  _SpotDetailsWidgetState createState() => _SpotDetailsWidgetState();
}

class _SpotDetailsWidgetState extends State<SpotDetailsWidget>
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ReviewsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ReviewsRecord> spotDetailsReviewsRecordList = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                              ...
                              Padding(
                                ...
                                child: Text(
                                  functions.ratingSummaryList(
                                      spotDetailsReviewsRecordList.toList()),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyText2
                                      .override(
                                        fontFamily: 'Lexend Deca',
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (formatNumber(
                            spotDetailsReviewsRecordList.length,
                        ...
                        StreamBuilder<List<FavoritesRecord>>(
                          stream: queryFavoritesRecord(
                            queryBuilder: (favoritesRecord) =>
                                favoritesRecord.where('propatyRef',
                                    isEqualTo: widget.propertyRef!.reference),
                            singleRecord: true,
                          ),
                          builder: (context, snapshot) {
                            ...
                            List<FavoritesRecord> buttonFavoritesRecordList =
                                snapshot.data!;
                            final buttonFavoritesRecord =
                                buttonFavoritesRecordList.isNotEmpty
                                    ? buttonFavoritesRecordList.first
                                    : null;
