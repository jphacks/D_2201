                                  ...
                                  children: [
                                    Transform.rotate(
                                      angle: (-(double.parse(valueOrDefault<String>(dateTimeFormat('yy/MM/dd HH:mm', datePicked), dateTimeFormat('yy/MM/dd HH:mm', getCurrentTimestamp)).replaceAll(RegExp(r"[^0-9]"), "").substring(2, 4)) * 30 +
                                                  ...
                                                  267 +
                                                  6) -
                                              (double.parse(valueOrDefault<String>(dateTimeFormat('yy/MM/dd HH:mm', datePicked), dateTimeFormat('yy/MM/dd HH:mm', getCurrentTimestamp)).replaceAll(RegExp(r"[^0-9]"), "").substring(6, 8)) +
                                                      double.parse(valueOrDefault<String>(dateTimeFormat('yy/MM/dd HH:mm', datePicked), dateTimeFormat('yy/MM/dd HH:mm', getCurrentTimestamp)).replaceAll(RegExp(r"[^0-9]"), "").substring(8, 10)) /
                                                          60) *
                                                  15) *
                                          pi /
                                          180,
